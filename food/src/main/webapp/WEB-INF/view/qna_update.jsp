	...
	<div id="wrap">
		...
		<section>
			<div id="bonmun">
				...
				<form name="board_form" method="post" action="qna_update">
					<input type="hidden" name="no" value="${dto.no}">
					<div class="col1">
						<input type="text" name="title" value="${dto.title}" placeholder="Title">
					</div>
					...
					<div class="col3">
						<textarea rows="30" cols="102" name="content" placeholder="Content">${dto.content}</textarea>
					</div>
