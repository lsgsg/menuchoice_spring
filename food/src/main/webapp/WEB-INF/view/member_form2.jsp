...
<div id="signup">
   <ul id="Sul">
      <form name="member_form" method="post" action="clientjoin2">
         <li id="SulL" class="Sull">
            <ul>
               <li>
                  <p><span>*</span>&nbsp;아이디&nbsp;
                  </p> <input type="text" name="id" readonly="readonly" value="${id}" />
               </li>
               <li>
                  <p>
                     <span>*</span>&nbsp;나이&nbsp;
                  </p>
                  <input type="text" name="age" placeholder="세">&nbsp;&nbsp;
               </li>
               <li>
                  <p>
                     <span>*</span>&nbsp;성별&nbsp;
         ...
         <li id="SulR" class="Sull">
            <ul>
               ...
               <li id="button">
                  <button type="submit" class="btn-1" style="margin: 24px 0 0 0 ; width:260px;">INPUT</button>
               </li>
            </ul>
         </li>
      </form>
